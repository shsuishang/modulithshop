  ...
  var anim = 'layui-anim-upbit', events = {
    ...
    , chatLog: function (othis) {
      ...
      return events.chatLog.index = layer.open({
        ...
        , content: cache.base.chatLog + '?id=' + (thatChat.data.id || thatChat.data.user_id) + '&type=' + thatChat.data.type + '&store_id=' + thatChat.data.store_id + '&friend_id=' + thatChat.data.friend_id
      });
    }
