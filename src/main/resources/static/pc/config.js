...
const base_url_dev = 'http://127.0.0.1:8101' // 本地环境地址
const base_url_release = '' // 公司线上环境地址

const base_url = is_dev ? base_url_dev : base_url_release
const admin_url = is_dev ? "http://127.0.0.1:5173" : base_url_release + "/admin"
...
window.admin_url = admin_url || getUrlParam('admin_url');
window.base_url = base_url;
window.api_url = api_url || getUrlParam('api_url')
...
SYS.CONFIG['order_lists'] = api_url + '/front/trade/order/list'
SYS.CONFIG['browser_lists'] = api_url + '/front/shop/userProductBrowse/list'
