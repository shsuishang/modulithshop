...
const is_dev = false // 本地环境 true , 线上false
const base_url_dev = 'https://demo.modulithshop.cn' // 本地环境地址
const base_url_release = 'https://demo.modulithshop.cn' // 公司线上环境地址
const base_url = is_dev ? base_url_dev : base_url_release

const api_url = is_dev ? base_url_dev : base_url_release + ''
...
if (ukey) {
  ukey = escape(ukey).replace(/\+/g, '%2B')
}
SYS.VER = '2.0.277';
SYS.DEBUG = 0;

SYS.CONFIG['base_url'] = base_url
SYS.CONFIG['im_config'] = api_url + "/front/account/userMessage/getImConfig?uid=" + uid
...
SYS.CONFIG['msg_chathistory_lists'] = api_url + '?mdu=sns&ctl=User_Message&met=listChatMsg&perm_key=' + ukey + '&perm_id=' + uid
...
SYS.CONFIG['msg_add'] = api_url + '?mdu=sns&ctl=User_Message&met=add&perm_key=' + ukey + '&perm_id=' + uid
SYS.CONFIG['upload'] = api_url + '/mobile/admin/oss/upload'
SYS.CONFIG['order_lists'] = base_url_release + '/index.php?ctl=User_Order&met=lists&perm_key=' + ukey + '&perm_id=' + uid
SYS.CONFIG['browser_lists'] = base_url_release + '/index.php?ctl=User_Favorites&met=browser&action=item&perm_key=' + ukey + '&perm_id=' + uid
