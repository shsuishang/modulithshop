...
import com.suisung.shopsuite.pt.model.entity.ProductAskBase;
import com.suisung.shopsuite.pt.model.req.ProductAskBaseAddReq;
import com.suisung.shopsuite.pt.model.req.ProductAskBaseEditReq;
import com.suisung.shopsuite.pt.model.req.ProductAskBaseListReq;
import com.suisung.shopsuite.pt.service.ProductAskBaseService;
...
public class ProductAskBaseController extends BaseController {
    ...
    @ApiOperation(value = "商品咨询-分页列表查询", notes = "商品咨询-分页列表查询")
    ...
    @ApiOperation(value = "商品咨询-通过ask_id查询", notes = "商品咨询-通过ask_id查询")
    ...
    @ApiOperation(value = "商品咨询-添加", notes = "商品咨询-添加")
    ...
    @ApiOperation(value = "商品咨询-编辑", notes = "商品咨询-编辑")
    ...
    @ApiOperation(value = "商品咨询-通过ask_id删除", notes = "商品咨询-通过ask_id删除")
    ...
    @ApiOperation(value = "商品咨询-批量删除", notes = "商品咨询-批量删除")
