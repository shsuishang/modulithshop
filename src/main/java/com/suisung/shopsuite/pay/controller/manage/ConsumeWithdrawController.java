...
import com.suisung.shopsuite.pay.model.req.ConsumeWithdrawEditReq;
...
public class ConsumeWithdrawController extends BaseController {
    ...
    @ApiOperation(value = "提现申请表-分页列表查询", notes = "提现申请表-分页列表查询")
    ...
    @ApiOperation(value = "提现申请表-编辑", notes = "提现申请表-编辑")
