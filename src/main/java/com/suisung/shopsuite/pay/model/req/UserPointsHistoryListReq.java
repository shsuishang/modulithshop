...
@ApiModel(description = "会员积分日志表分页查询")
public class UserPointsHistoryListReq extends BaseListReq {
    ...
    public UserPointsHistoryListReq() {
        setSidx("points_log_id");
