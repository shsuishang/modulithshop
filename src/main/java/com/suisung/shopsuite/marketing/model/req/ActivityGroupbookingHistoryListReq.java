...
@ApiModel(description = "拼团记录表分页查询")
public class ActivityGroupbookingHistoryListReq extends BaseListReq {
    ...
    private String gbEnable;

    public ActivityGroupbookingHistoryListReq() {
        setSidx("gbh_id");
