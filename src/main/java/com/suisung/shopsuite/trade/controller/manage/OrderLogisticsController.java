...
import com.suisung.shopsuite.trade.model.req.OrderLogisticsAddReq;
import com.suisung.shopsuite.trade.model.req.OrderLogisticsEditReq;
...
public class OrderLogisticsController extends BaseController {
    ...
    @ApiOperation(value = "订单发货物流信息表-分页列表查询", notes = "订单发货物流信息表-分页列表查询")
    ...
    @ApiOperation(value = "订单发货物流信息表-通过order_logistics_id查询", notes = "订单发货物流信息表-通过order_logistics_id查询")
    ...
    @ApiOperation(value = "订单发货物流信息表-添加", notes = "订单发货物流信息表-添加")
    ...
    @PreAuthorize("hasAuthority('/manage/trade/orderBase/shipping')")
    @ApiOperation(value = "订单发货物流信息表-编辑", notes = "订单发货物流信息表-编辑")
