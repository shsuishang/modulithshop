...
@ApiModel(description = "商品SKU存放详情表分页查询")
public class WarehouseItemListReq extends BaseListReq {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty("仓库商品编号")
    private Long warehouseItemId;

    @ApiModelProperty("商品编号（冗余）")
    private Long productId;

    @ApiModelProperty("商品单位id（冗余）")
    private Integer unitId;

    @ApiModelProperty("goods_info_id")
    ...
    @ApiModelProperty("锁定库存:实际库存-锁定库存=可售库存	")
