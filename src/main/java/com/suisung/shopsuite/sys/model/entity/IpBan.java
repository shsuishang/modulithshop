...
@ApiModel(value = "IpBan对象", description = "IP禁止表")
...
public class IpBan implements Serializable {
    ...
    @ApiModelProperty("自动打开(BOOL):1-自动解锁; 0-人工解锁")
    @TableField("ban_autorelease")
    private Boolean banAutorelease;

    @ApiModelProperty("锁定状态(ENUM):1-锁定中; 2-已解锁")
    @TableField("ban_status")
    private Boolean banStatus;

    @ApiModelProperty("锁定类型(ENUM):1-禁止访问; 2-禁止注册")
    @TableField("ban_type")
