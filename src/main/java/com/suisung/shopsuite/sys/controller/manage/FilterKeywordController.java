...
import com.suisung.shopsuite.sys.model.req.FilterKeywordAddReq;
import com.suisung.shopsuite.sys.model.req.FilterKeywordEditReq;
...
public class FilterKeywordController extends BaseController {
    ...
    @ApiOperation(value = "敏感词过滤-启用api-分页列表查询", notes = "敏感词过滤-启用api-分页列表查询")
    ...
    @ApiOperation(value = "敏感词过滤-启用api-添加", notes = "敏感词过滤-启用api-添加")
    ...
    @ApiOperation(value = "敏感词过滤-启用api-编辑", notes = "敏感词过滤-启用api-编辑")
    ...
    @ApiOperation(value = "敏感词过滤-启用api-通过filter_id删除", notes = "敏感词过滤-启用api-通过filter_id删除")
    ...
    @ApiOperation(value = "敏感词过滤-启用api-批量删除", notes = "敏感词过滤-启用api-批量删除")
